...
const SettlementInfo = ({
  ...
  return (
    <>
      ...
      >
        <div className="grid grid-cols-4 container mx-auto px-0 gap-8 mt-3 text-left">
        ...
        <div className="grid grid-cols-2 container mx-auto px-0 gap-8 mt-10 text-left">
          <div className="border-r-2">
            ...
            <div className="grid grid-cols-2 mx-auto gap-8 mt-3">
              <div>
                ...
                <div className="text-sm font-normal text-[#848789]">{unit}</div>
              </div>
              <div>
                <div className="text-sm font-normal">
                  ...
                  <div className="flex items-center">
                    ...
                    <Button.Group className="ml-2">
                      ...
                      <Button
                        ...
                        style={{
                          backgroundColor:
                            generationSortDirection == "desc" ? "#87BE33" : "",
                        }}
                        size="compact-sm"
                        onClick={() =>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 container mx-auto gap-8 mt-3">
              ...
              <div>
                <div className="text-sm font-normal">Load Weighted Average</div>
                <div className="text-xl font-bold">
        ...
        {remainingEnergyAttributeData && openModalRemainingEnergyAttribute && (
