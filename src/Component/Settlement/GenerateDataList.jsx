...
import { getGenerateDataInputList,
...
const GenerateDataList = () => {
    ...
    const generateDataList = useSelector((state) => state.settlement.generateDataInputList)
    const generateDataMonthList = useSelector((state)=>state.settlement.generateDataMonthList)
    const generateDataYearList = useSelector((state)=>state.settlement.generateDataYearList)
    ...
    const Highlight = ({ children, highlightIndex }) => (
      ...
      useEffect(()=>{
        if(currentUGTGroup?.id && selectYear && selectMonth){
            dispatch(getGenerateDataInputList(currentUGTGroup?.id,selectYear,selectMonth))
        }
                ...
                <div className="col-span-2 mb-4">
                  <span className="font-bold text-lg">
                    ...
                    >
                      ...
                      {generateDataList.length > 1 ? "Portfolios" : "Portfolio"}
                    </label>
                  </span>
                </div>
