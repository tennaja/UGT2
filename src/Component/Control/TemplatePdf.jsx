...
<table className="w-full border-collapse mb-5 text-xs">
            ...
            <tr>
              <td className="border p-2 h-96 break-all" colSpan="4">
                <div className='flex flex-col'>
                <p className='break-all'>On behalf of the Registrant, {data?.Sign == "" ? "" : data?.Sign.organisationName == null ? "[ ]" :  `[${data.Sign.organisationName}]`}, I agree to be subject to the I‑REC Code for Electricity and warrant that the information contained in this application is truthful and exhaustive.</p>
