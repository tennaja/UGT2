        ...
        <div className="pt-4 pb-5 pl-3 pr-3">
          <div className="text-center sm:mt-4">
            ...
            <div className="flex items-center text-left mt-4">
              ...
              <label className="ms-2 text-sm text-gray-600">I confirm all the required information is completed and the necessary supporting information and files are attached.</label>
            </div>
          </div>
        </div>
