...
console.log(data)
  ...
  const filteredData = sortedData?.filter((obj) => {
    for (let key in obj) {
      ...
      } else if(key == "portfolioName" || key == "numberDevices" || key == "numberSubscribers" || key == "numberBeneficiary" || key == "yearSettlement" || key == "status"){
        if (
...
export default DataTableRedemption;
